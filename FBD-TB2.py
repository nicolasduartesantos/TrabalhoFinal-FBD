    ...
    while True:
        ...
        if opc == "I":
            ...
            if opc_i == "1":
                ...
                rec.append(input("Digite o semestre: "))
                ...
                try:
                    ...
                    print('\n\033[31mERRO: A chave primária deve ser única.\033[m \n')
                except psycopg2.errors.ForeignKeyViolation:
                    print('\n\033[31mERRO: A chave estrangeira digitada não existe.\033[m \n')
                except psycopg2.errors.RaiseException:
                    print('\n\033[31mERRO: A turma não possui mais vagas.\033[m \n')


            elif opc_i == "2":
                rec = []
                rec.append(input("Digite o nome: "))
                ...
                rec = []
                rec.append(input("Digite a data: "))
                rec.append(int(input("Digite o id da disciplina: ")))
                rec.append(input("Digite o tipo: "))
                ...
                rec.append(int(input("Digite o id do reitor atual: ")))
                rec.append(input("Digite o nome do reitor atual: "))
                ...
                rec.append(int(input("Digite o id do campus: ")))
                rec.append(int(input("Digite o id do diretor: ")))
                ...
                try:
                    ...
                    print('\n\033[31mERRO: Erro, confirme as informações inseridas.\033[m \n')
                ...
                rec.append(int(input("Digite o id do coordenador: ")))
                ...
                rec = []
                rec.append(input("Digite a matricula: "))
                rec.append(input("Digite a nota: "))
                rec.append(int(input("Digite o id da disciplina: ")))
                rec.append(input("Digite a data: "))
                ...
                rec.append(input("Digite a lotação do local: "))
                rec.append(input("Digite o bloco o qual o local faz parte: "))
                ...
                resp_coord = input("O(A) professor(a) é coordenador(a)? ")
                resp_coord = resp_coord.upper()
                if resp_coord == "SIM":
                    rec.append("1")
                    rec.append("0")
                else:
                    rec.append("0")
                    resp_diretor = input("O(A) professor(a) é diretor(a)? ")
                    resp_diretor = resp_diretor.upper()
                    if resp_coord == "SIM":
                        rec.append("1")
                    else:
                        rec.append("0")
                rec.append(input("Digite a data de nascimento: "))
                resp_reitor = resp_coord = input("O(A) professor(a) é reitor(a)? ")
                ...
                try:
                    ...
                    con.commit()
                    if resp_reitor == "SIM" or resp_reitor == "S":
                ...
                rec.append(int(input("Digite o id do professor: ")))
                rec.append(input("Digite o grau de formação: "))
                resp_coord = input("Ele(a) é coordenador(a)? ")
                resp_coord = resp_coord.upper()
                if resp_coord == "SIM":
                    rec.append("1")
                    rec.append("0")
                    ...
                    rec.append("0")
                    resp_diretor = input("Ele(a) é diretor(a)? ")
                    resp_diretor = resp_diretor.upper()
                    if resp_coord == "SIM":
                        rec.append("1")
                    else:
                ...
                rec.append(int(input("Digite o id do local: ")))
                rec.append(int(input("Digite o id da turma: ")))
                rec.append(input("Digite o semestre (no formato ano.semestre): "))
                ...
                rec.append(int(input("Digite o id da disciplina: ")))
                rec.append(input("Digite o número de vagas: "))
                rec.append(input("Digite o número de matriculados: "))
                rec.append(input("Digite o semestre (no formato ano.semestre): "))
                rec.append(int(input("Digite o id da turma: ")))
            ...
            if opc_i == "1":
                ...
                id_aluno = int(input("Digite a matrícula do aluno da tupla que será removida: "))
                id_disc = int(input("Digite o id da disciplina da tupla que será removida: "))
                semestre = input("Digite o semestre da tupla que será removida: ")
                ...
                try:
                    ...
                    print('\n\033[31mERRO: Não foi possível remover a tupla.\033[m \n')


            elif opc_i == "2":
                print('\033[95mDigite a chave primária da tupla que será removida: \033[m')
                matricula = int(input("Digite a matrícula do aluno da tupla que será removida: "))
                ...
                print('\033[95mDigite a chave primária da tupla que será removida: \033[m')
                id_disc = int(input("Digite o id da disciplina da tupla que será removida: "))
                data = input("Digite a data da tupla que será removida: ")
                ...
                print('\033[95mDigite a chave primária da tupla que será removida: \033[m')
                id_campus = int(input("Digite o id do campus da tupla que será removida: "))
                ...
                print('\033[95mDigite a chave primária da tupla que será removida: \033[m')
                id_centro = int(input("Digite o id do centro da tupla que será removida: "))
                ...
                print('\033[95mDigite a chave primária da tupla que será removida: \033[m')
                id_prof = int(input("Digite o id do professor da tupla que será removida: "))
                id_curso = int(input("Digite o id do curso da tupla que será removida: "))

                try:
                    cur.execute('DELETE FROM compoe WHERE id_prof = %s AND id_curso = %s', (id_prof, id_curso))
                    con.commit()
                    print('\n\033[32mTupla removida com sucesso! \033[m')
                except:
                    print('\n\033[31mERRO: Não foi possível remover a tupla.\033[m \n')
                ...
                print('\033[95mDigite a chave primária da tupla que será removida: \033[m')
                id_aluno = int(input("Digite o id do aluno da tupla que será removida: "))
                id_curso = int(input("Digite o id do curso da tupla que será removida: "))
                ...
                try:
                    cur.execute('DELETE FROM faz_avaliacao WHERE id_aluno = %s AND id_disc = %s AND data = %s', (id_aluno, id_disc, data))
                    con.commit()
                    print('\n\033[32mTupla removida com sucesso! \033[m')
                except:
                    print('\n\033[31mERRO: Não foi possível remover a tupla.\033[m \n')
                ...
                print('\033[95mDigite a chave primária da tupla que será removida: \033[m')
                id_local = int(input("Digite o id do local da tupla que será removida: "))
                ...
                print('\033[95mDigite a chave primária da tupla que será removida: \033[m')
                id_reitor = int(input("Digite o id do reitor da tupla que será removida: "))
                ...
                print('\033[95mDigite a chave primária da tupla que será removida: \033[m')
                id_local = int(input("Digite o id do local da tupla que será removida: "))
                id_turma = int(input("Digite o id da turma da tupla que será removida: "))
                semestre = input("Digite o semestre da tupla que será removida: ")
            ...
            if opc_i == "1":
                ...
                aluno = int(input("Digite a matrícula do aluno da tupla que será atualizada: "))
                disc = int(input("Digite o id da disciplina da tupla que será atualizada: "))
                semestre = input("Digite o semestre da tupla que será atualizada: ")

                print('\n\033[95mDigite os novos dados: \033[m')
                rec.append(aluno)
                rec.append(disc)
                rec.append(input("Digite o id da turma: "))
                rec.append(semestre)

                try:
                    cur.execute('UPDATE aluno_faz SET id_aluno= %s,id_disc= %s,id_turma= %s,semestre= %s WHERE id_aluno = %s AND id_disc = %s AND semestre = %s', (rec[0], rec[1], rec[2], rec[3], aluno, disc, semestre))
                    con.commit()
                ...
                rec.append(input("Digite o id do reitor atual: "))
                rec.append(input("Digite o nome do reitor atual: "))
                ...
                rec.append(input("Digite o id do campus: "))
                rec.append(input("Digite o id do diretor: "))
                ...
                rec.append(input("Digite a carga horária: "))
                rec.append(id_curso)
                rec.append(input("Digite o id do centro do curso: "))
                rec.append(input("Digite o id do coordenador: "))
                ...
                rec.append(input("Digite a carga horária: "))
                rec.append(id_disc)
                rec.append(input("Digite o id do professor: "))
                ...
                rec.append(input("Digite a descrição do local: "))
                rec.append(id_local)
                rec.append(input("Digite o id do centro que o local faz parte: "))
                rec.append(input("Digite a lotação do local: "))
                rec.append(input("Digite o bloco o qual o local faz parte: "))
                ...
                rec.append(input("Digite o horário: "))
                rec.append(input("Digite os dias da semana: "))
                rec.append(input("Digite o id da disciplina: "))
                rec.append(input("Digite o número de vagas: "))
                rec.append(input("Digite o número de matriculados: "))
                rec.append(input("Digite o semestre (no formato ano.semestre): "))
                rec.append(id_turma)
                ...
                try:
                    cur.execute('UPDATE turmas SET nome= %s,estado= %s,horario= %s, dias_semana= %s, id_disc= %s, num_vagas= %s, num_matriculados= %s, semestre= %s,id_turma= %s WHERE id_turma = %s ', (rec[0], rec[1], rec[2], rec[3], rec[4], rec[5], rec[6], rec[7], rec[8], id_turma))
                    con.commit()
